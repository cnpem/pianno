...
_pianno_ is the short form of **Pi**mega **Anno**tator, an
auxiliar tool for the process of alignment of modules and stripes
of the Pimega detectors' images.

With _pianno_ one can annotate points in the images and export them for
...
The _pianno_ application is available in the following link:
